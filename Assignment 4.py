...
Emp1=Manager("Ganesh",28,"emp5868",56000000,"CTO")
Emp2=Manager("Gaurav",28,"emp5869",56000000,"ASTROLOGER")
Emp3=Manager("Shantanu",28,"emp5888",56000000,"DESIGN HEAD")
Emp4=Manager("Sai",28,"emp5868","000000000000000000.1₹","CEO")
Emp1.display()
Emp2.display()
Emp3.display()
Emp4.display()
